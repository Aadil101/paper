...
% Not super happy with the title, any ideas?
...
% I'm a bit confused on whether the stuff below should go in related work, or introduction?
\begin{itemize}
...
\begin{itemize}
  ...
  % obviously we can't show samples for all our features, but how about for some of the important ones? any of these below?:
  \begin{itemize}
...
% Do you agree/disagree with how I've categorized these features? not totally happy with how I've grouped them yet...
...
\begin{itemize}
  ...
  % is this Zipf's law, if so should I mention it here?
...
\begin{itemize}
  % do is_acronym and is_pronoun fall under lexical?
...
\begin{itemize}
  % does POS tag of target word fall under syntactic?
...
\begin{itemize}
  ...
  % Do you think I should include performance per subcorpus (bible, biomed, europarl), or any other performances?
\end{itemize}
...
\begin{itemize}
  % is showing feature importances worth it? if so, how should I measure feature importance? 
